...
public class TimeUtil {
    ...
    public static void main(String[] args) {
        System.out.println(TimeUtil.getNo(8));
    }
    // 类获取今天、昨天、本周、上周、本年及特定时间
    // 的开始时间和结束时间（返回类型为date类型）
    /**
     * 获取当天开始时间
     * @return
     */
    ...
    /**
     * 取得数据库主键 生成格式为yyyymmddhhmmss+n位随机数
     * @param n：表示是取几位随机数，可以自己定
     * @return
     */
    public static String getNo(int n) {
        return getUserDate("yyyyMMddhhmmss") + getRandom(n);
    }
}
